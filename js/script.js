...
const componentes = [
	{
		...
		detalhamento: [
			"<ul>",
			"<li>Equipamento em aço inox AISI 316, chapa de 3/16'', volume de 4L de óleo térmico interno</li>",
			"<li>Aquecimento por resistência elétrica de 2KW</li>",
			"<li>Termopar tipo J destinado ao controle do aquecimento</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Controlador de temperatura</li>",
	...
	},
	{
		...
		detalhamento: [
			"<ul>",
			"<li>Equipamento em aço inox AISI 316, chapa de 3/16'', volume de 20L de óleo térmico interno</li>",
			"<li>Aquecimento por resistência elétrica de 2KW</li>",
			"<li>Bomba de Engrenagem de 1/2 c.v.</li>",
			"<li>Termopar tipo J destinado ao controle do aquecimento</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Controlador de temperatura</li>",
			"<li>POP – Procedimento operacional Padrão.</li>",
	...
	},
	{
		...
		detalhamento: [
			"<ul>",
			"<li>Tanque de alimentação em aço inox, 60 Litros (OPCIONAL)</li>",
			"<li>Centrífuga em aço carbono e central em alumínio </li>",
			"<li>Motor de 3 CV</li>",
			"<li>Resistência aquecedora destinada a redução de viscosidade</li>",
	...
	},
	{
		...
		detalhamento: [
			"<ul>",
			"<li>Estrutura em alumio naval, podendo também ser confeccionado em aço inoxidável</li>",
			"<li>Visor em vidro boro silicato</li>",
			"<li>Parafusos para fixação das placas de proteção</li>",
			"</ul>"
		],
		croqui: "",
		img: [""],
...
const equipamentos = [
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Tanques de alimentação para óleo e água em aço carbono com chapa de 3/16''</li>",
			"<li>Tubos Sch40 de 1/2''</li>",
			"<li>Indicadores de vazão tipo rotâmetro</li>",
			"<li>Indicadores de pressão tipo Bourbon</li>",
			"<li>Válvulas de controle tipo globo de 1/2''</li>",
			"<li>Válvulas de retenção de 1/2''</li>",
			"<li>Válvulas de alívio de 1/2''</li>",
			"<li>Resistência de imersão de 800 W</li>",
			"<li>Inversores de frequência</li>",
			"<li>Esquide com rodízios destinado ao suporte de todos os equipamentos</li>",
			"<li>Quadro elétrico com inversores de frequência</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Reator para cocção em aço inox de 60 L, chapa 3/16'', motor de 1/2 c.v., agitação por pás tipo turbina</li>",
			"<li>Tanque de borra em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em vidro boro silicato, válvula inferior destinado a descarga de material</li>",
			"<li>Tanque para coleta de óleo em aço carbono, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em vidro boro silicato, válvula inferior destinado a descarga de material</li>",
			"<li>Aquecedor elétrico em aço carbono, volume de 30L, chapa 3/16'', potência de 8 kW</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Bombas de engrenagem de 1/2 c.v. destinadas ao transporte de fluídos no sistema</li>",
			"<li>Sensores de pressão tipo Termopar J</li>",
			"<li>Válvula de segurança com abertura de até 5 bar de pressão interna</li>",
			"<li>Esquide em aço carbono com rodízios</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Reator de cocção em aço inox de 60 L, chapa 3/16'', motor de 1/2 c.v., agitação por pás tipo turbina</li>",
			"<li>Reator de cocção em aço inox de 50 L, chapa 3/16'', motor de 1/2 c.v., agitação por pás tipo turbina, sistema de condensação destinado a quebra de nevoeiro, zona para inserção de vácuo</li>",
			"<li>Trocadores de calor em aço carbono (dois), chapa 3/16'', 32 tubos BWG, vedação com papelão hidráulico</li>",
			"<li>Tanque de borra em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em vidro boro silicato, válvula inferior destinado a descarga de material</li>",
			"<li>Tanque de condensados em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em boro silicato,válvula inferior destinada a retirada de material a ser analisada</li>",
			"<li>Aquecedor elétrico em aço carbono, volume de 30L, chapa 3/16'', potencia de 8 kW</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Bombas de engrenagem (quatro) de 1/2 c.v. destinadas ao transporte de fluídos no sistema</li>",
			"<li>Bomba de vácuo destinada a secagem do óleo</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Sensores de pressão tipo Termopar J</li>",
			"<li>Válvula de segurança com abertura de até 5 bar de pressão interna</li>",
			"<li>Esquide em aço carbono com rodízios</li>",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Tanques de alimentação em aço inoxidável, chapa 3/16'', com visor de nível e sensores de nível capacitivos</li>",
			"<li>Sensor de vazão tipo placa de orifício com sensores de pressão tipo Bourdon</li>",
			"<li>Visor de vazão tipo Rotâmetro</li>",
			"<li>Visor de fluxo em vidro boro silicato destinado a compreensão de fluxo de material e funcionamento de válvulas de controle (válvula borbuleta)</li>",
			"<li>Válvulas on-off com atuadores elétricos</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Bombas centrífugas de ½ c.v. destinado ao transporte de fluídos no sistema</li>",
			"<li>Inversor de Freqüência</li>",
			"<li>CLP – Controlador lógico Programável</li>",
			"<li>Supervisório em Plataforma SCADA Sensores de Pressão Termopar tipo J</li>",
			"<li>Esquide em aço carbono com rodízios</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>"
		],
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Tanque de alimentação: Aço inox, chapa 3/16'', com visor de nível e indicador de temperatura lateral</li>",
			"<li>Trocadores de calor: Aço inox AISI 304, chapa 3/16'', 32 tubos BWG, vedação com papelão hidráulico, destinados a compreensão de aquecimento e resfriamento</li>",
			"<li>Aquecedor: Aço inox AISI 316 com resistência interna de 2kW</li>",
			"<li>Trocador bitubular: Aço inox</li>",
			"<li>Caldeira: Aço inox, chapa 3/16''. Normatizada pela NR13. Aquecimento por resistências elétricas de 10kW. Válvula de segurança para 8bar de pressão. Indicadores de pressão tipo Bourbon. Termopar tipo K destinado ao monitoramento da temperatura</li>",
			"<li>Tanque destinado à compressão de vapores e condensação: Normatizado pela NR13. Indicador de pressão tipo Bourbon e válvula de segurança</li>",
			"<li>Tanque de recuperação: Aço inox, chapa 3/16'', destinado à recuperação de vapores oriundos da condensação em trocadores de calor</li>",
			"<li>Purgadores: Tipo boia, balde invertido e termodinâmicos</li>",
			"<li>Filtros em Y: Destinados a remoção de sujeitas do sistema</li>",
			"<li>Válvulas: Vapores, retenção, passagem direta e controle de fluxo</li>",
			"<li>Rotâmetros: Destinados ao estudo de vazão na tubulação</li>",
			"<li>Indicadores de temperatura: Tipo J, em trechos da tubulação destinados ao monitoramento da perda de temperatura nos trechos do sistema</li>",
			"<li>Tubulação: Schedule 40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Fluxograma: Montagem em CAD e impressão em acrílico da tubulação de maneira a tornar o sistema mais didático</li>",
			"<li>Bombas centrífugas: 1/2 c.v. destinado ao transporte de fluídos no sistema</li>",
			"<li>Bomba de engrenagem: 1/2 c.v. destinada ao fluxo de óleo térmico da caldeira elétrica</li>",
			"<li>Torre de refrigeração: Modular</li>",
			"<li>Inversores de frequência</li>",
			"<li>Esquide em aço carbono com rodízios</li>",
			"<li>POP: Procedimento operacional padrão.</li>",
			"</ul>"
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Unidade de bombeamento em aço carbono e pintura epóxi</li>",
			"<li>Motor de 3/4 c.v.</li>",
			"<li>Esquide em aço carbono destinado à sustentação estrutural</li>",
			"<li>Reservatório em aço inox AISI 316L</li>",
			"<li>Sistema de sucção em aço inox e vedação em polietileno</li>",
			"<li>Tanque de refluxo em aço inox e vidro boro silicato</li>",
			"<li>Quadro elétrico trifásico com inversor de frequência.</li>",
			"</ul>"
		],
		croqui: "",
		img: [""],
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Coluna de destilação em aço inox AISI 304, diâmetro de 4'', recheio cerâmico com 1/8 do diâmetro da coluna, 4 estágios separados por flanges e vedação por papelão hidráulico</li>",
			"<li>Trocador de calor em aço inox AISI 304, chapa 3/16'', 32 tubos BWG, vedação com papelão hidráulico</li>",
			"<li>Tanque de alimentação em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em vidro boro silicato, válvula inferior destinado a descarga de material</li>",
			"<li>Tanque de condensados em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em boro silicato,válvula inferior destinada a retirada de material a ser analisada</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Bombas centrífugas de 1/2 c.v. destinadas ao transporte de fluídos no sistema</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Sensores de Pressão tipo Termopar K</li>",
			"<li>Transdutores e sensores de vazão</li>",
			"<li>Transdutores e sensores de pressão</li>",
			"<li>Inversores de frequência</li>",
			"<li>Válvulas elétricas de controle</li>",
			"<li>Quadro elétrico</li>",
			"<li>Válvula de segurança com abertura de até 5 bar de pressão interna</li>",
			"<li>POP – Procedimento operacional padrão.</li>",
			"</ul>"
	...
	},
	{
		...
		detalhamento: [
			...
			"<li>Tanque de condensados em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em boro silicato, válvula inferior destinada a retirada de material a ser analisada</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Bombas centrífugas de 1/2 c.v. destinado ao transporte de fluídos no sistema</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Sensores de pressão tipo Termopar J</li>",
			"<li>Válvula de segurança com abertura de até 5 bar de pressão interna</li>",
			"<li>Esquide em aço carbono com rodízios</li>",
	...
	},
	{
		...
		detalhamento: [
			...
			"<ul>",
			"<li>Coluna de destilação em aço inox AISI 304, diâmetro de 4'', recheio cerâmico com 1/8 do diâmetro da coluna, 4 estágios separados por flanges e vedação por papelão hidráulico</li>",
			"<li>Trocadores de calor (dois) em aço inox AISI 304, chapa 3/16'', 32 tubos BWG, vedação com papelão hidráulico</li>",
			"<li>Tanque de alimentação em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em vidro boro silicato, válvula inferior destinado a descarga de material</li>",
			"<li>Tanques de condensados (dois) em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em boro silicato,válvula inferior destinada a retirada de material a ser analisada</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Bomba centrífugas de 1/2 c.v. destinada ao transporte de fluídos no sistema</li>",
			"<li>Bomba de vácuo destinada a redução de pressão no sistema</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Sensores de temperatura tipo Termopar J</li>",
			"<li>Válvula de segurança com abertura de até 5 bar de pressão interna</li>",
			"<li>Esquide em aço carbono co rodízios</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Caldeira geradora de vapor normatizada, NR13</li>",
			"<li>Tanque de alimentação, em aço inox AISI 316L, de materia da qual será removida o óleo essencial</li>",
			"<li>Trocador de calor, tipo casco e tubos, em aço inox AISI 316L</li>",
			"<li>Tanque de condensados em aço carbono com visor de nível em vidro boro silicato</li>",
			"<li>Válvulas de controle tipo gaveta</li>",
			"<li>Mini torre de refrigeração</li>",
			"<li>Bomba centrifuga</li>",
			"<li>Controlador de temperatura</li>",
			"<li>Estrutura modular</li>",
			"<li>Quadro elétrico</li>",
			"<li>Visores de fluxo</li>",
			"<li>Procedimento Operacional Padrão.</li>",
			"</ul>"
		],
		croqui: "",
		img: [""],
	...
	},
	{
		...
		detalhamento: [
			...
			"<ul>",
			"<li>Tanques de alimentação para óleo e água em aço carbono com chapa de 3/16''</li>",
			"<li>Torre de extração líquido–líquido com cinco estágios em vidro boro silicato, prato de contato entre as fases de teflon</li>",
			"<li>Tubulação em teflon e válvulas punk-flow</li>",
			"<li>Sistema de aquecimento tipo caldeira com resistência de imersão</li>",
			"<li>Bomba de engrenagem</li>",
			"<li>Bomba centrífuga</li>",
			"<li>Válvulas de controle de fluxo tipo globo</li>",
			"<li>Válvulas abertura rápida tipo esfera</li>",
			"<li>Inversores de frequência</li>",
			"<li>Esquide com rodízios destinado ao suporte de todos os equipamentos</li>",
			"<li>Quadro elétrico com inversores de frequência</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Dornas de fermentação em aço inox AISI 316</li>",
			"<li>Bombas dosadoras de elementos necessários a manutenção de pH</li>",
			"<li>Ciclones de remoção de leveduras</li>",
			"<li>Tanques de alimentação e obtenção do calco fermentado</li>",
			"<li>Quadro elétrico</li>",
			"<li>Automação com IHM</li>",
			"<li>Procedimento operacional Padrão (POP).</li>",
			"</ul>"
		],
		croqui: "",
		img: [""],
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Tanques de alimentação para óleo e água em aço carbono</li>",
			"<li>Misturador estático tipo convergente</li>",
			"<li>Banco de agitadores com motor redutor</li>",
			"<li>Tanque FAD em acrílico</li>",
			"<li>Indicadores de vazão para água e óleo tipo rotâmetros</li>",
			"<li>Tanque para utilização de surfactante</li>",
			"<li>Sistema de bombeamento com bombas tipo centrífuga</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Suporte do sistema tipo esquide em aço carbono</li>",
			"<li>Quadro elétrico com inversores de frequência</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>"
		],
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Cuba em aço inox AISI 304, chapa 3/16'', vedação com papelão hidráulico</li>",
			"<li>Agitação interna com pás estilo ''raspador''</li>",
			"<li>Moto-redutor destinado a proporcionar um maior torque ao sistema de secagem</li>",
			"<li>Manômetro tipo Bourbon destinado ao acompanhamento da pressão durante a secagem</li>",
			"<li>Sensores de pressão tipo Termopar J</li>",
			"<li>Válvula de segurança com abertura de até 5 bar de pressão interna</li>",
			"<li>Esquide em aço carbono destinado a sustentação do sistema, perfil em L de 1.1/2''</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Alimentador vertical em aço inox AISI 316</li>",
			"<li>Motor de 1/4 c.v.</li>",
			"<li>Parafuso helicoidal em aço inox AISI 316</li>",
			"<li>Forno com camisa externa em aço inox AISI 316</li>",
			"<li>Sensores de temperatura e pressão</li>",
			"<li>Quadro elétrico trifásico</li>",
			"<li>Esquide em aço carbono destinado a suportar a estrutura</li>",
			"<li>POP – Procedimento operacional Padrão.</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Parafusos sextavados M3 ao M10 em aço carbono</li>",
			"<li>Parafusos Allen M4</li>",
			"<li>Tubos SCH40 de 4''</li>",
			"<li>Tubos SCH40 de 2''</li>",
			"<li>Tubos SCH40 de 1''</li>",
			"<li>Tubos SCH40 de 3/4''</li>",
			"<li>Tubos SCH40 de 1/2''</li>",
			"<li>Tubos SCH40 de 1/4''</li>",
			"<li>Chapas AISI 304 de 1/2''</li>",
			"<li>Chapas AISI 304 de 3/8''</li>",
			"<li>Chapas AISI 304 de 1/4''</li>",
			"<li>Chapas AISI 304 de 3/16''</li>",
			"<li>Chapas AISI 304 de 1/8''</li>",
			"<li>Chapas AISI 304 de 1/16”</li>",
			"<li>Chapas AISI 304 de 1/32''</li>",
			"<li>Esquide em aço carbono com rodízios</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>"
		],
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Coluna de destilação em aço inox AISI 304, diâmetro de 2'', pratos com borbulhadores, 4 estágios* separados por flanges e vedação por papelão hidráulico</li>",
			"<li>Trocador de calor em aço inox AISI 304, chapa 3/16'', 32 tubos BWG, vedação com papelão hidráulico</li>",
			"<li>Tanque de Condensados em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em boro silicato, válvula inferior destinada a retirada de material a ser analisada</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Indicador de Pressão tipo Bourbon</li>",
			"<li>Sensores de Pressão tipo Termopar K</li>",
			"<li>Manta aquecedora para balão de fundo redondo</li>",
			"<li>Válvula de segurança com abertura de até 5 bar de pressão interna</li>",
			"<li>Esquide em aço carbono com rodízios</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>",
			"*o número de estágios pode varia de acordo com as necessidades do projeto"
		],
		croqui: "",
		img: [""],
		vr: []
	},
	{
		...
		detalhamento: [
			...
			"Módulo 1:",
			"<ul>",
			"<li>Reator Batelada, volume de 2L, em aço inox, pás de agitação em teflon, agitadores com inversores de frequência</li>",
			"<li>Visor de nível em vidro boro silicato</li>",
			"<li>Indicador de temperatura tipo J</li>",
			"<li>Coluna de lavagem em aço inox AISI 304</li>",
			"<li>POP – Procedimento operacional Padrão.</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			...
			"Módulo 1",
			"<ul>",
			"<li>Reatores CSTR, volume de 2L, em aço inox AISI 316, pás de agitação em teflon, agitadores com inversores de frequência</li>",
			"<li>Sistema de aquecimento tipo caldeira com resistência de imersão</li>",
			"<li>Bomba de engrenagem</li>",
			"<li>Válvulas de controle de fluxo tipo globo</li>",
			"<li>Válvulas abertura rápida tipo esfera</li>",
	...
	},
	{
		...
		detalhamento: [
			...
			"Módulo 1: <br>",
			"<ul>",
			"<li>Reatores CSTR, volume de 2L, em vidro borosilicato, pás de agitação em teflon, agitadores com inversores de frequência</li>",
			"<li>Reatores PFR em vidro borosilicato, recheios em com anéis de raschig em borosilicato, juntas em teflon e acoplamento personalizado em teflon</li>",
			"<li>Decantador Horizontal em vidro borosilicato, zona de coalescência recheada com anéis de raschig em material cerâmico, acoplamento em tecnyl</li>",
			"<li>Aquecedor elétrico estático em aço inox AISI 304 com espiras destinadas ao fluxo contínuo de óleo vegetal</li>",
			"<li>Mixer estático em aço inox AISI 304</li>",
			"<li>Tanque de alimentação de óleo vegetal em aço carbono, chapa 3/16''</li>",
			"<li>Tanque de alimentação de álcool etílico ou metílico em aço carbono, chapa 3/16''</li>",
			"<li>Tanque de alimentação de solução catalisadora em aço inox AISI 304, chapa 3/16''</li>",
			"<li>Bombas centrífugas, potencia de 1/4 c.v.</li>",
			"<li>Bomba de engrenagem, potencia de 1/2 c.v.</li>",
			"<li>Indicadores de Vazão de área variável tipo rotâmetro</li>",
			"<li>Indicadores de nível tipo haste lateral</li>",
			"<li>Tubulação em tubos de teflon</li>",
			"<li>Válvulas em aço carbono ou teflon. </li>",
			"</ul>",
			"<br>",
			...
			"<ul>",
			"<li>Tanques de alimentação para óleo e água em aço carbono com chapa de 3/16''</li>",
			"<li>Torre de extração líquido–líquido com cinco estágios em vidro borosilicato, prato de contato entre as fases teflon</li>",
			"<li>Tubulação em teflon e válvulas punk-flow</li>",
			"<li>Sistema de aquecimento tipo caldeira com resistência de imersão</li>",
			"<li>Bomba de engrenagem</li>",
			"<li>Bomba centrífuga</li>",
			...
			"<li>Coluna de destilação em aço inox AISI 304, diâmetro de 4”, recheio cerâmico com 1/8 do diâmetro da coluna, 4 estágios separados por flanges e vedação por papelão hidráulico</li>",
			"<li>Trocador de calor em aço inox AISI 304, chapa 3/16'', 32 tubos BWG, vedação com papelão hidráulico</li>",
			"<li>Tanque de alimentação em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em vidro borosilicato, válvula inferior destinado a descarga de material</li>",
			"<li>Tanque de condensados em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em borosilicato, válvula inferior destinada a retirada de material a ser analisada</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Bombas centrífugas de 1/2 c.v. destinado ao transporte de fluídos no sistema</li>",
			"<li>Indicador de Pressão tipo Bourbon</li>",
			"<li>Sensores de Pressão tipo Termopar J</li>",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"Módulo 1: Pirólise do Material",
			"<ul>",
			"<li>Reator por batelada, volume de 3L, em aço inox, pás de agitação em aço, agitadores com inversores de frequência</li>",
			"<li>Aquecimento por resistência elétrica de 10kW</li>",
			"<li>Termopar tipo K destinado ao controle do aquecimento</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Motor de 3/4 c.v.</li>",
			"</ul>",
			"<br>",

			"Módulo 2: Recuperação do bio óleo e lavagem do gás gerado",
			"<ul>",
			"<li>Trocadores de calor casco e tubos em aço inox AISI 304</li>",
			"<li>Tanques de 2L em aço inox</li>",
			"<li>Coluna em vidro boro silicato destinada a lavagem do gás gerado durante a pirólise</li>",
			"<li>Esquide em aço carbono com rodízios</li>",
			"<li>Procedimento Operacional padrão – POP.</li>",
			"</ul>"
		],
	...
	},
	{
		...
		detalhamento: [
			...
			"Módulo 1: Pirólise do Material",
			"<ul>",
			"<li>Reator com alimentação contínua, volume de 3L, em aço inox, aquecimento por resistência elétrica de 10kW</li>",
			"<li>Termopar tipo K destinado ao controle do aquecimento</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Motor de 3/4 c.v.</li>",
			"</ul>",
			...
			"<li>Trocadores de calor casco e tubos em aço inox AISI 304</li>",
			"<li>Tanques de 2L em aço inox</li>",
			"<li>Coluna de separação em aço inox AISI 316 com sangrias laterais</li>",
			"<li>Termopares tipo K em toda a unidade, destinados ao monitoramento do sistema</li>",
			"<li>Torre de resfriamento</li>",
			"<li>Esquide em aço carbono</li>",
			"<li>POP (Procedimento Operacional padrão).</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			...
			"Módulo 1 – Pirólise do Material ",
			"<ul>",
			"<li>Reator Batelada, volume de 1L, em aço inox, sem agitação, em aço</li>",
			"<li>Aquecimento por resistência elétrica de 10KW</li>",
			"<li>Termopar tipo K destinado ao controle do aquecimento</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Isolamento em cerâmica. </li>",
			"</ul>",
			"<br>",
			...
			"<ul>",
			"<li>Trocadores de calor casco e tubos em aço inox AISI 304</li>",
			"<li>Tanques de 200 mL em aço inox</li>",
			"<li>Esquide em aço carbono com rodízios</li>",
			"<li>Procedimento Operacional padrão – POP</li>",
			"</ul>"
		],
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Reator em aço inox AISI 316L, volume de 20 L, agitação por pás tipo hélice, motor de 1/2 c.v.</li>",
			"<li>Trocador de calor em aço inox AISI 304</li>",
			"<li>Caldeira elétrica com resistências de 2kW</li>",
			"<li>Torre de refrigeração com bomba de 1/2 c.v. e motor de 1/2 c.v.</li>",
			"<li>Estrutura com rodízios e dispositivo de freios</li>",
			"<li>POP - Procedimento operacional Padrão.</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Balão de alimentação em vidro boro silicato com camisa (500 mL)</li>",
			"<li>Balão de alimentação em vidro boro silicato sem camisa (500mL)</li>",
			"<li>Condensador de refluxo em boro silicato</li>",
			"<li>Balão para coleta de vapores (250 mL)</li>",
			"<li>Manta aquecedora (100–500°C) com controle de temperatura e isolamento em lã de rocha</li>",
			"<li>Agitador com inversor de frequência (IKA)</li>",
			"<li>Suporte em aço inox 304.</li>",
			"</ul>"
		],
		croqui: "",
		img: [""],
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Tanques em aço carbono (dois), chapa 3/16'', volume de 15 Litros</li>",
			"<li>Trocador de calor em aço carbono, chapa 3/16'', 32 tubos BWG, vedação em papelão hidráulico</li>",
			"<li>Tanque de condensados em aço carbono, chapa 3/16'', com suspiro destinado a equalização da pressão, visores de nível lateral em boro silicato,válvula inferior destinada a retirada de material a ser analisada</li>",
			"<li>Aquecedor elétrico em aço carbono, volume de 30L, chapa 3/16'', potência de 8Kw</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Bomba de engrenagem de 1/2 c.v. destinada ao transporte de fluidos no sistema</li>",
			"<li>Bomba de vácuo destinada a secagem do óleo</li>",
			"<li>Tanque flash em aço inox AISI 304, chapa 3/16'', sistema de quebra névoa, serpentina com tubos BWG, visor de nível</li>",
			"<li>Indicador de Pressão tipo Bourbon</li>",
			"<li>Sensores de Pressão tipo Termopar J</li>",
			"<li>Válvula de segurança com abertura de até 5 bar de pressão interna</li>",
			"<li>Esquide em aço carbono com rodízios</li>",
			"<li>Quadro elétrico com inversor de frequência</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Reator em aço inox AISI 304, Barra circular 110mm x 145mm</li>",
			"<li>Chapa aquecedora com controle de temperatura e velocidade de agitação</li>",
			"<li>Isolamento externo em vibra de vidro</li>",
			"<li>Capela em vidro temperado</li>",
			"<li>Válvula de alívio, pressão de abertura 1500 a 2000Psi a 288°C – 1/4''NPT</li>",
			"<li>Termopar tipo ''T'', rosca G1/4'' para alta pressão</li>",
			"<li>Conector macho G1/4'' para tubulação alta pressão 1/4''OD IHM – Interface homem máquina</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			...
			"Módulo 1",
			"<ul>",
			"<li>Reator por batelada, volume de 800L, em aço inox , pás de agitação em aço, agitadores com inversores de frequência</li>",
			"<li>Decantador vertical em aço inox, zona de coalecencia no próprio reator</li>",
			"<li>Aquecedor elétrico estático em aço inox AISI 304 com espiras destinadas ao fluxo contínuo de óleo vegetal</li>",
			"<li>Mixer estático em aço inox AISI 304</li>",
			"<li>Tanque de alimentação de óleo vegetal em aço carbono, chapa 3/16''</li>",
			"<li>Tanque de alimentação de álcool etílico ou metílico em aço carbono, chapa 3/16''</li>",
			"<li>Tanque de alimentação de solução catalisadora em aço inox AISI 304, chapa 3/16''</li>",
			"<li>Bombas centrífugas, potência de 1/4 c.v.</li>",
			"<li>Bomba de engrenagem, potência de 1/2 c.v.</li>",
			"<li>Indicadores de vazão de área variável tipo rotâmetro</li>",
			"<li>Indicadores de nível tipo haste lateral</li>",
			"<li>Tubulação em tubos de teflon</li>",
			"<li>Válvulas em aço carbono ou teflon</li>",
	...
	},
	{
		...
		detalhamento: [
			...
			"<li>Tanques de alimentação para óleo e água em aço carbono</li>",
			"<li>Misturador estático tipo convergente</li>",
			"<li>Decantador horizontal em aço inox</li>",
			"<li>Separador Hidrociclone</li>",
			"<li>Flotador em aço inox</li>",
			"<li>Indicador de temperatura</li>",
			"<li>Sensor de Temperatura</li>",
			"<li>Visor de nível em vidro boro silicato</li>",
			"<li>Indicador de Vazão tipo rotâmetro</li>",
			"<li>Indicadores de vazão para água e óleo tipo rotâmetros</li>",
			"<li>Tanque para utilização de surfactante</li>",
			"<li>Caldeira de aquecimento de olé térmico</li>",
			"<li>Sistema de bombeamento com bombas tipo centrífuga</li>",
			"<li>Suporte do sistema tipo esquide em aço carbono</li>",
			"<li>Quadro elétrico com inversores de frequência</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
	...
	},
	{
		...
		detalhamento: [
			...
			"<li>Trocador de calor em aço inox AISI 304, chapa 3/16'', 32 tubos BWG, vedação com papelão hidráulico</li>",
			"<li>Tanque de alimentação em aço inox AISI 304, chapa 3/16'', suspiro destinado a equalização da pressão, visores de nível lateral em vidro boro silicato, válvula inferior destinado a descarga de material</li>",
			"<li>Aquecedor elétrico com potencia de 15 kW em aço inox AISI 304, chapa 3/16”. Isolamento externo utilizando lã de rocha com espessura de 1''. Tampos laterais com chapa de 1/4'' PMTA de 8 bar de pressão</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Bombas centrífugas de 1/2 c.v. destinado ao transporte de fluídos no sistema</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Sensores de pressão tipo Termopar J</li>",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Tanques de alimentação em aço inox, chapa 3/16'', com visor de nível e sensores de nível capacitivos</li>",
			"<li>Trocadores de calor em aço inox AISI 304, chapa 3/16'', 32 tubos BWG, vedação com papelão hidráulico, destinados a compreensão de aquecimento e resfriamento</li>",
			"<li>Aquecedor em aço inox AISI 316 com resistência interna de 2kW</li>",
			"<li>Trocador em acrílico, destinado a compreensão de fluxo de corrente e mecânica construtiva</li>",
			"<li>Tubulação em acrílico destinado a compreensão de fluxo de material e funcionamento de válvulas de controle (válvula borboleta)</li>",
			"<li>Tubulação SCH40, pintura epóxi de acordo com normas industriais</li>",
			"<li>Bombas centrífugas de 1/2 c.v. destinadas ao transporte de fluídos no sistema</li>",
			"<li>Torre de refrigeração modular</li>",
			"<li>Indicador de pressão tipo Bourbon</li>",
			"<li>Inversores de frequência</li>",
			"<li>CLP – Controlador lógico Programável</li>",
			"<li>Supervisório em plataforma SCADA</li>",
			"<li>Sensores de Pressão tipo Termopar J</li>",
			"<li>Estrutura em aço carbono com rodízios</li>",
			"<li>POP (Procedimento operacional padrão).</li>",
			"</ul>"
		],
		croqui: "",
	...
	},
	{
		...
		detalhamento: [
			"<br>",
			"<ul>",
			"<li>Tanque de alimentação em aço inox, 80 Litros</li>",
			"<li>Medidor de Venturi</li>",
			"<li>Filtro de areia</li>",
			"<li>Sistema de gradeamento em aço inox</li>",
			"<li>Floculador</li>",
			"<li>Sistema de cloração</li>",
			"<li>Bomba centrifuga com motor de 3/4 c.v.</li>",
			"<li>POP – Procedimento Operacional Padrão.</li>",
			"</ul>"
		],
		croqui: "",
